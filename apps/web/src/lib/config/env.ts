...
export const env = {
  ...
  polymarketSignatureType:
    String(import.meta.env.VITE_POLYMARKET_SIGNATURE_TYPE ?? "").trim(),
  polymarketFunderAddress: optionalEnvAddress(
    import.meta.env.VITE_POLYMARKET_FUNDER_ADDRESS,
  ),
  protocolAddressOverrides: {
    ...
    acrossSpokePoolPolygon: optionalEnvAddress(import.meta.env.VITE_ACROSS_SPOKE_POOL_POLYGON),
    ...
    wrappedNativePolygon: optionalEnvAddress(import.meta.env.VITE_WRAPPED_NATIVE_POLYGON),
    ...
    usdcPolygon: optionalEnvAddress(import.meta.env.VITE_USDC_POLYGON),
